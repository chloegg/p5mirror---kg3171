...
class Player {
  constructor() {
    this.x = 50;
    this.y = ground - 30;  // Make sure the player starts on the ground
    this.vy = 0;  // Initial vertical velocity
    this.gravity = 0.6;
    this.img = playerImg;  // Assign the loaded image to a property of the player
    this.width = this.img.width / 2;  // Scale the image size if needed
